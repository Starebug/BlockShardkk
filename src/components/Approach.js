    ...
    return (
        <div className="bg-[#001552] flex  justify-around ">
            <div className='flex flex-col justify-center gap-[2rem]'>
                ...
                <div className='flex '>
                    <div className='text-white w-[28rem] text-[1.3rem]  anton-regular'>SecureShare combines powerful, cutting edge technologies such as the cloud, blockchain and cryptography to deliver the first all-in-one cloud storage solution for both businesses and consumers.</div>
