...
const Hero = () => {
  return (
    <div className='flex content-start justify-evenly my-[3rem] '>
      <div className='flex content-start flex-col w-[30rem] gap-[1rem]'>
        <h1 className='madimi-one-regular text-[3.5rem] font-bold'>
          For the First Time

          Store and Transfer

          <span className='text-[#2874fc]'>{" "} Securely</span>
        </h1>
        <h3 className='text-[1.3rem] text-gray-500'>
          SecureShare enables users to store, process
          and share their data while ensuring its privacy and security.

        </h3>
        <Link to='/redirect'>
        <div className='bg-[#2874fc] hover:bg-[#2876fcf1] w-[18rem] flex justify-center cursor-pointer py-[1rem] text-[0.9rem] text-white font-bold'>
           Get Started
        </div>
        </Link>
